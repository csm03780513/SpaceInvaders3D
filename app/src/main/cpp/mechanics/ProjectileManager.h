...
public:
    ...
    void spawnAlienBullet(glm::vec2 spawnPos);
    void update(float dt);
    void handleCollisions(std::span<Alien> aliens, Ship &ship, MainPushConstants &shipPC, AlienManager &alienManager);
    void tryAlienFire(float dt, AlienManager &alienManager);
